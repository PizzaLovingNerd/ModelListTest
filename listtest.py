...
def stores_from_database():
    ...
    for app in apps_columns:
        ...
        app_store = AppItem.new_installed(app[0], app[1], app[2], app[3], True, app[6])
...
try:
    with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "appListButton.ui"), "rb") as file:
        ui_bytes = file.read()
